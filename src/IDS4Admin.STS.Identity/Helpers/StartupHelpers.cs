...
using IDS4Admin.STS.Identity.Configuration;
using IDS4Admin.STS.Identity.Configuration.ApplicationParts;
using IDS4Admin.STS.Identity.Configuration.Constants;
using IDS4Admin.STS.Identity.Configuration.Interfaces;
using IDS4Admin.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace IDS4Admin.STS.Identity.Helpers
{
